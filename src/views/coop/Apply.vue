<template>
    <div>
        <group title='基本信息' label-margin-right="1em"    >
            ...
            <sinSelector sTitle='类型' :isRequired="true" sPlaceholder='请选择' :dataList="dictionary.actCategory" :sendData="applyData.type" :selectedItem.sync="applyData.type"></sinSelector>
            <mulSelectors sTitle='标签' :max="3" :isRequired="true" sPlaceholder='请选择' :dataList="needLabel" :sendData="applyData.labelList" :selectedItem.sync="applyData.labelList"></mulSelectors>
