                ...
                <div class="w-100">
                    <div class="disc-text">
                        ...
                        <div class="long-content">
                            ...
                            <span class="long-text font-orange">{{el.travelStatusValue}}</span>
                        </div>
                        <div class="long-content">
...
export default {
    ...
    methods: {
        ...
        getMysendList(pageNo, type) {
            com.covertHttp(api.queryMyTravelFlowList,{
                pageNo: pageNo,
        ...
        clickLoadMore() {
            ...
            com.covertHttp(api.queryMyTravelFlowList,{
                pageNo: this.page,
                pageSize: this.pageSize,
                travelStatus: this.expenseStatus
            }).then(rtn => {
        ...
        gotoApprovalDetail(id) {
            if (id == "") return
            this.$router.push({ path: "/trip/detail/" + id + "/myself/0" });
        }
    }
}
</script>
