  ...
  <div>
    <scrollPosition>
      <div>
        ...
        <div class="prompt" v-if="count == 0" style="height:100%">
    ...
    <div class="fixed-btn">
      ...
      <x-button class="smallbtn" type="primary" :mini="true" @click.native="showSearchBox"
        >筛选</x-button
      >
    </div>
...
export default {
  ...
  methods: {
    ...
    gotoDetail(id) {
      ...
      this.$router.push({ path: `/customer/detail/${id}/1` });
    },
    search() {
      // 搜索
