                ...
                <div class="w-100">
                    <div class="disc-text">
                        ...
                        <div class="long-content">
                            ...
                            <span class="long-text">{{el.applyTime}}</span>
                        </div>
                        <div class="long-content">
                            <span class="disc-title long-title">办理类型</span>
                            <span class="long-text">{{el.handleTypeValue}}</span>
                        </div>
                        <div class="long-content">
                            <span class="disc-title long-title">需求数量</span>
                            <span class="long-text">{{el.personelNum}}</span>
                        </div>
                        <div class="long-content">
                            <span class="disc-title long-title">当前状态</span>
                            <span class="long-text font-orange">{{el.resourcesHandleStatusValue}}</span>
                        </div>
                        <div class="long-content">
...
export default {
    ...
    methods: {
        ...
        getMysendList(pageNo, type) {
            com.covertHttp(api.resourcesHandleFlowList,{
                pageNo: pageNo,
                pageSize: this.pageSize,
                resourcesHandleStatus: type
            }).then(rtn => {
        ...
        clickLoadMore() {
            ...
            com.covertHttp(api.resourcesHandleFlowList,{
                pageNo: this.page,
                pageSize: this.pageSize,
                resourcesHandleStatus: this.expenseStatus
            }).then(rtn => {
        ...
        gotoApprovalDetail(id) {
            if (id == "") return
            this.$router.push({ path: "/resHandle/detail/" + id + "/myself/0" });
        }
    }
}
</script>
