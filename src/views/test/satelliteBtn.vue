<template>
    <div class="mobile-canvas" :class="isOpen ? 'open':''">
        <div class="button-container" :class="isOpen ? 'open':''" @click="toggleBtn">
            <div class="button-wrapper">
                ...
                <div class="button-child-wrapper">
                    <slot></slot>
                    <!-- <div class="button-child" @click="emitType(1)">
                        <slot name= "first"></slot>
                    </div>
                    <div class="button-child" @click="emitType(2)">
                        <slot name= "second"></slot>
                    </div>
                    <div class="button-child" @click="emitType(3)">
                        <slot name= "last"></slot>
                    </div> -->
                </div>
            </div>
...
.button-container.open .button-child span {
  opacity: 1;
  visibility: visible;
  transition-delay: 500ms;
}
...
.button-child:nth-child(2) span {
  -webkit-transform: rotate(-45deg);
          transform: rotate(-45deg);
}
.button-child:nth-child(3) span {
  -webkit-transform: rotate(-90deg);
          transform: rotate(-90deg);
}
.button-child span {
