<template>
    <div v-if="isReady">
        <group title='基本信息' label-margin-right="1em"    >
            ...
            <!-- <MapInfo sTitle='地图' :isRequired="true" sPlaceholder='请选择' :itemData="mapdata"></MapInfo> -->
            ...
            <!-- <departTree2 sTitle='归属部门' :isRequired="true" sPlaceholder='请选择' :dataList="departList" :sendData="applyData.remarks" :selectedItem.sync="applyData.remarks"></departTree2> -->
