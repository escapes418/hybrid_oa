...
export default {
    ...
    methods: {
        ...
        getMysendList(pageNo, type) {
            ...
            // api.queryMyDemandImplementOrMarketList(pageNo,this.pageSize,type,1).then(rtn => {
        ...
        clickLoadMore() {
            ...
            // api.queryMyDemandImplementOrMarketList(this.page, this.pageSize, this.expenseStatus,1).then(rtn => {
