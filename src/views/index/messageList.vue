    ...
    <group v-if="count !== 0">
      <cell-box v-for="(el, index) in listData" :key="index" @click.native="gotoDetail(el)" is-link>
        <div class="message_list">
          <span class="font-red" v-if="el.billType == '12'">【可前往web端查看详情】</span
          >{{ el.sendMessage }}
        </div>
      </cell-box>
    </group>
...
export default {
  ...
  methods: {
    ...
    getList(opts) {
      ...
      com
        .covertHttp(api.findMessagePage, {
          ...postData,
    ...
    gotoDetail(el) {
      var type = '';
      if (el.billType === '1') {
        //流程类型：1市场，2实施，3报销，4接待，5出差，6资源，7资源办理，8开户，9合同，10合同归档
