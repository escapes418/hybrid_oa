...
export default {
  ...
  methods: {
    init() {
      ...
      if (params.firstSubCode) {
        com
          .covertHttp(api.queryExpenseHistoryDetailList, {
            firstSubCode: params.firstSubCode,
            secondSubCode: params.secondSubCode == '0' ? '' : params.secondSubCode,
            time: params.time,
          ...
          .then(rtn => {
            ...
            this.dataArr.forEach((item, index) => {
              item.subjectName = rtn.data[index].subjectName.join(' ');
