                ...
                <div class="w-100">
                    <div class="detail-text">
                        ...
                        <div class="long-content">
                            ...
                            <span class="long-detail">{{dataArr.detail.contractCode}}</span>
                        </div>
                        <div class="long-content">
                        ...
                        <div class="long-content">
                            ...
                            <span class="long-detail">{{dataArr.detail.contractTypeTxt}}</span>
                        </div>
                        <div class="long-content">
            ...
            if (params.id) {
                if (params.type && (params.type === 'todo' || params.type === 'done' || params.type === 'myself')) {
                    ...
                    com.covertHttp(api.contractFlowDetail,{
                        ...
                        this.dataArr.detail = rtn.data.contractFlowDetailInfoNewResponse;
                        this.gerAttachmentList = this.dataArr.detail.contractAttachmentList || []
