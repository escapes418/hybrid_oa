                ...
                <div class="w-100">
                    <div class="disc-text">
                        ...
                        <div class="long-content">
                            ...
                            <span class="long-text">{{el.budgetTotal||0 | thousands(2) }}元</span>
                        </div>
                        <div class="long-content">
                            <span class="disc-title long-title">当前状态</span>
                            <span class="long-text font-orange">{{el.recpStatusValue}}</span>
                        </div>
                        <div class="long-content">
...
export default {
    ...
    methods: {
        ...
        getMysendList(pageNo, type) {
            ...
            com
                .covertHttp(api.queryMyRecpFlowList, {
                    pageNo: pageNo,
                    pageSize: this.pageSize,
                    expenseStatus: type,
                    billType: 4
        ...
        gotoApprovalDetail(id) {
            if (id == "") return;
            this.$router.push({
                path: "/reception/detail/" + id + "/myself" + "/0"
            });
        }
    }
};
