  ...
  <div>
    <group title="基本信息" label-margin-right="1em">
      ...
      <departTree
        ...
        sPlaceholder="请选择"
        :dataList="departList"
        :sendData="applyData.officeId"
        :selectedItem.sync="applyData.officeId"
      ></departTree>
      <departTree
        sTitle="市场负责人"
        :isRequired="true"
        :isPeople="true"
        sPlaceholder="请选择"
        :dataList="marketLeaderList"
        :sendData="applyData.marketLeaderId"
        :selectedItem.sync="applyData.marketLeaderId"
      ></departTree>
      <departTree
        sTitle="项目负责人"
        :isRequired="true"
        :isPeople="true"
        sPlaceholder="请选择"
        :dataList="projectLeaderList"
        :sendData="applyData.projectLeaderId"
        :selectedItem.sync="applyData.projectLeaderId"
      ></departTree>
      <departTree
        sTitle="实施负责人"
        :isRequired="true"
    ...
    <group
      ...
      v-for="(item, index) in applyData.projectNodeReqs"
      :key="index"
    >
      <box gap="10px 15px">
